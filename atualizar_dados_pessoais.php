    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            ></a>
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="painel_.php" class="nav-link">Setores</a>
                </li>
            </ul>
                                        ...
                                        <div class="content-wrapper">
                                            ...
                                            <section class="content-header">
                                                <div class="container-fluid">
                                                    <div class="row mb-2">
                                                        <div class="col-sm-9">
                                                            <h1>&nbsp;Digite o CPF que deseja atualizar os dados pessoais.</h1><br>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.container-fluid -->
                                            ...
                                            <!-- Main content -->
                                            <form id="formPersonalData" action="enviar_atualizar_dados_pessoais.php" method="post">  
