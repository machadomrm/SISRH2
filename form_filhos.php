...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <!-- Main Sidebar Container -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="row">
                    ...
                    <div class="row mb-2" style='margin-left:2px;'>
                        <div class="col-sm-12">
                            <h1><strong>Cadastro de Dependentes</strong></h1>
                        </div>
                    </div>
                    <hr>
                </div>
            ...
            <!-- Main content -->
            <form id="formPersonalData" action="salvar_form_filhos.php" method="post">  
                <section class="content">
                    ...
                    <div class="col-md-4" id="add-filho">
    ...
    <script src="js/addFilho.js"></script>
