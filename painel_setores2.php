                                        ...
                                        <div class="content-wrapper">
                                            ...
                                            <section class="content-header">
                                                <div class="container-fluid">
                                                    <div class="row mb-2">
                                                        <div class="col-sm-9">
                                                            <h1>&nbsp;&nbsp;&nbsp;Selecione a opção desejada</h1><br>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- /.container-fluid -->
                                            ...
                                            <section class="content">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <span style="font-size:9px; margin-right:5px"><i class="fas fa-hospital-alt"></i></span>Cadastro de Setor
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <span style="font-size:9px; margin-right:5px"><i class="fas fa-user-tie" ></i></span>Cadastro de Chefe de Setor
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <span style="font-size:9px; margin-right:5px"><i class="fas fa-list" ></i></span>Relação de Setores
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        ...
                                                        <span style="font-size:9px; margin-right:5px"><i class="fas fa-list-ol" ></i></span>Relação de Chefe de Setores
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
