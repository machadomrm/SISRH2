...
<body class="hold-transition sidebar-mini">
    ...
    <div class="container-fluid">
            <div class="row mb-2" style='margin-left:2px;'>
                <div class="col-sm-12">
                <h1><strong>Detalhes</strong></h1><hr>
                </div>
            </div>
    </div>    
        ...
        <div class="row" style='margin-left: 1em;'>
            ...
            <div class="col-md-3">
                ...
                <label for="setor_hosp">Setor Hospital</label>
                <input type="text" name="setorHospital" class="form-control" required />
            </div> 

            <div class="col-md-4">
                        
                <label for="setor_sei">Setor S.E.I</label>
                <input type="text" name="setorSei" class="form-control" required />
            </div>
        ...
        <div class="row" style='margin-left: 1em;'>
            ...
            <div class="col-md-2">
                ...
                <input type="txt " name="data_admissao" class="form-control" />

            </div>

            <div class="col-md-2">

                <label for="nome">Portaria</label><br>
                <input type="text" name="nome_func" class="form-control" required />
        ...
        <div class="row" style='margin-left: 1.5em;'>
            <a href=""><button class="btn btn-success" type="button">Enviar</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <!-- <a href="desvincular.php"><button class="btn btn-primary" type="button">Desvincular</button></a>&nbsp;&nbsp;&nbsp;&nbsp; -->
            <a href=""><button class="btn btn-info" type="button">Imprimir</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="relacaoChefiadeSetores.php"><button class="btn btn-danger" type="button">Voltar</button></a>
        </div>
