            ...
            <form id="formPersonalData" action="atualizar_form_dadospessoais.php" method="post">  
                <section class="content">
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Nome Completo:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $nome_func; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Data Nasc:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $data_nasc; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>CPF:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $cpf_func; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>RG:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $rg_func; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Cartão SUS:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $sus; ?></div>
                    </div>
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Prontuário Procape:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $pront; ?></div>
                    </div>
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Tipo Sanguíneo:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $tipo_sang; ?></div>
                    </div>
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Conjugue:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $nome_conjugue; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Nome da Mãe:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $nome_mae; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Nome do Pai:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $nome_pai; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Estado Civil:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $estado_civil; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Escolaridade:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $escolaridade; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>CEP:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $cep; ?></div>
                    </div>
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Logradouro:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $logradouro; ?></div>
                    </div>

                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Bairro:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $bairro; ?></div>
                    </div>
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-2" ><span style="float: right;">
                            <strong>Nacionalidade:</strong></div>
                        <div class="col-md-4" ><span style="float: left;">
                            <?php echo $nacionalidade; ?></div>
                    </div>
                    ...
                    <?php 
                        ...
                        while($row = $pesquisa2->fetch_assoc()) 
                        {
                          ...
                          echo "  <div class='row' style='margin-left: 1em;'>
                                <div class='col-md-2' ><span style='float: right;'>
                                    <strong>Dependentes:</strong></div>
                                <div class='col-md-4' ><span style='float: left;'>
                                ".$nome_filho."&nbsp;&nbsp;<strong>Data Nasc: </strong>".$nasc_filho."</div>
                            </div>";
