    ...
    <div class="wrapper">
      ...
      <!-- Main Sidebar Container -->
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2" style='margin-left:8px;'>
                        <div class="col-sm-6">
                            <h1><strong>Dados Profissionais</strong></h1>
                        </div>
                    </div>
                    <hr>
                </div>
            ...
            <!-- Main content -->
            <form id="formPersonalData" action="atualizar_form_dadosprofissionais.php" method="post">  
                ...
                <!-- <fieldset>
                    ...
                    <div class="row" style='margin-left: 1em;'>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="matricula" class="form-control" value="<?php echo $matricula; ?>" required />
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="conselho" class="form-control" value="<?php echo $conselho; ?>" required />
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" name="ctps" id="ctps" value="<?php echo $ctps; ?>" class="form-control" />
                        ...
                        <div class="col-md-1">
                            ...
                            <input type="number" name="serie_ctps" id="serie_ctps" value="<?php echo $serie_ctps; ?>" class="form-control" />
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" name="pis" class="form-control" value="<?php echo $pis; ?>" required />
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" name="data_pis" class="form-control" value="<?php echo $data_pis; ?>" />
                    ...
                    <div class="row" style='margin-left: 1em;'>                      
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="id_tipopresta" class="form-control" required>
                                <option value="<?php echo $id_tipopresta; ?>"><?php echo $tipo_presta; ?></option>
                                <?php
								$conn = mysqli_connect("192.168.150.26","root","huprocape#99","banco_rh");
								if (mysqli_connect_errno())
								{
                ...
                <div class="row" style='margin-left: 1em;'>    
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" name="data_exercicio" value="<?php echo $data_exercicio; ?>"class="form-control" />
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="setor_sei" name="id_setor" class="form-control" required="">
                                <option value="<?php echo $id_setor; ?>"><?php echo $nome_setor; ?></option>
                                <?php
								$conn = mysqli_connect("192.168.150.26","root","huprocape#99","banco_rh");
								if (mysqli_connect_errno())
								{
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="setor_sei" name="sigla_sei" class="form-control" required="">
                                <option value="<?php echo $sigla_sei; ?>"><?php echo $nome_setor_sei; ?></option>
                                <?php
								$conn = mysqli_connect("192.168.150.26","root","huprocape#99","banco_rh");
								if (mysqli_connect_errno())
								{
                        ...
                        <input type="date" name="data_adm" value="<?php echo $data_adm; ?>" class="form-control" />
                ...
                <div class="col-md-3">
                        ...
                        <input type="text" name="org_origem" class="form-control" value="<?php echo $org_origem; ?>" required />
                ...
                <div class="col-md-2">
                        ...
                        <input type="text" name="org_exercicio" class="form-control" value="<?php echo $org_exercicio; ?>" required />
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="sus" value="<?php echo $sus; ?>" class="form-control" />
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="vem" value="<?php echo $vem; ?>" class="form-control" />
                ...
                <div class="col-md-2">
                        ...
                        <input type="text" name="portaria" class="form-control" value="<?php echo $portaria; ?>" required />
            ...
            <br><hr>
                ...
                <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-8">
                            ...
                            <a target="_blank" href="pdf_dadosprofissionais.php?cpf_func=<?php echo $cpf_func; ?>"><button class="btn btn-primary" type="button">Imprimir</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
