...
<head>
    ...
    <title>SISRH - Relação Chefe de Setor </title>
    ...
    <style>
        ...
        <div class="container-fluid">
                    <div class="row mb-2" style='margin-left:2px;'>
                        <div class="col-sm-12">
                            <h1><strong>Lista de Chefes</strong></h1>
                        </div>
                    </div><hr>
                </div>    
        ...
        <tr>
            ...
            <td>Nome Setor</td>
            <td><a href="detalhes.php"><button>Detalhes</button></a></td>
            <td><a href="painel_setores.php"><button>Voltar</button></a></td>
        </tr>
