...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            ></a>
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="painel_setores" class="nav-link">Setores</a>
                </li>
            </ul>
            ...
            <!-- <section class="content-header"> -->
                <!-- <div class="container-fluid">
                    <div class="row mb-2" style='margin-left:8px;'>
                        <div class="col-sm-6">
                            <h4><strong>Informações de Férias</h4>
                        </div>
                    </div>
                </div> -->
                <!-- /.container-fluid -->
            ...
            <!-- <form id="formPersonalData" action="salvar_form_dadospessoais.php" method="post">  
                ...
                <div class="row" style='margin-left: 1em;'>
                    ...
                    <div class="col-md-5">
                        ...
                        <p>
                        Nome do Funcionário: <span style='color:blue;'>José de Castro</span><br>
                        CPF: <span style='color:blue;'>772.0273.235-63</span><br>
                        Setor: <span style='color:blue;'>Admissão e Alta</span><br>
                        Chefe do Setor: <span style='color:blue;'>Maria Oliveira</span><br>
                        Recebimento: <span style='color:blue;'>Fevereiro 2022</span><br>
                        1º parte gozo: <span style='color:blue;'>07/05/2022 à 14/05/2022</span><br>
                        2º parte do gozo: <span style='color:blue;'>12/07/2022 à 19/07/2022</span<br>
                ...
                <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-8">
                            <button class="btn btn-success" type="submit">Enviar MSG</button>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <style>
        ...
        <tr>
            <th>1ª Parte do Gozo:</th>
            <td>10/05/2021 à 25/05/2021</td>
           
        </tr>
        <tr>
            <th>2ª Parte do Gozo:</th>
            <td>10/11/2021 à 25/11/2021</td>
