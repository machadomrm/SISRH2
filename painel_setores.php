                                        ...
                                        <div class="content-wrapper">
                                            ...
                                            <section class="content-header">
                                                ...
                                                <div class="row mb-2" style='margin-left:2px;'>
                                                        <div class="col-sm-12">
                                                            <h1><strong>Selecione a opção desejada</strong></h1>
                                                        </div>
                                                </div>
                                                </div><hr>
                                                <!-- /.container-fluid -->
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
                                                            <a href="cad_setor.php">
                                                            <span style='color:red; font-size:10px; margin-right:5px'><i class="fa fa-play"></i></span><strong>Cadastro de Setor</strong>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
                                                            <a href="cad_chefeSetor.php">
                                                            <span style='color:red; font-size:10px; margin-right:5px'><i class="fa fa-play"></i></span><strong>Cadastro de Chefe de Setor</strong>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
                                                            <a href="relacaodesetores.php">
                                                            <span style='color:red; font-size:10px; margin-right:5px'><i class="fa fa-play"></i></span><strong>Relação de Setores</strong>
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
                                                            <a href="relacaoChefiadeSetores.php">
                                                            <span style='color:red; font-size:10px; margin-right:5px'><i class="fa fa-play"></i></span><strong>Relação de Chefe de Setores</strong>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
