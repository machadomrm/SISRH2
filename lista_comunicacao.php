                                        ...
                                        <div class="content-wrapper">
                                            ...
                                            <section class="content-header">
                                                ...
                                                <div class="row mb-2" style='margin-left:2px;'>
                                                    <div class="col-sm-12">
                                                        <h1><strong>Envio de Mensagens</strong></h1>
                                                    </div>
                                                </div>
                                                <hr>
                                                </div>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
													...
													<a href="">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Chefe de Setor</strong>
                                                    </div>
													</a>
                                                </div>
												...
												<div class="row">
                                                    <div class="col-md-2" style="margin-right: 35px; margin-left: 50px;">
													<a href="">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Funcionário</strong>
                                                    </div>
													</a>
                                                </div>
                                                ...
                                                <div class="row">
													...
													<a href="">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Órgão Externo</strong>
                                                    </div>
													</a>
                                                </div>
