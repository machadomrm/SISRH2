                                        ...
                                        <div class="content-wrapper">
                                            ...
                                            <section class="content-header">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-md-9" style="margin-right: 35px; margin-left: 50px;">
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-md-2" style="margin-right: 35px; margin-left: 50px;">
													<a href="list_dadospessoais.php?cpf_func=<?php echo $cpf_func; ?>">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Dados Pessoais</strong>
                                                    </div>
													</a>
                                                </div>
												...
												<div class="row">
                                                    <div class="col-md-2" style="margin-right: 35px; margin-left: 50px;">
													<a href="list_dadosprofissionais.php?cpf_func=<?php echo $cpf_func; ?>">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Dados Profissionais</strong>
                                                    </div>
													</a>
                                                </div>

                                                <div class="row">
                                                    <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
													<a href="http://192.168.150.26/rharquivos/<?php echo $cpf_func; ?>/index.php">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Documentos Anexados</strong>
                                                    </div>
													</a>
                                                </div>
												...
												<div class="row">
                                                    <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
													<a href="list_ferias.php">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Histórico de Férias</strong>
                                                    </div>
													</a>
                                                </div>
												...
												<div class="row">
                                                    <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
													<a href="list_historico_setores.php">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Histórico de Setores</strong>
                                                    </div>
													</a>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
													<a href="relatorios_func.php">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Relatórios</strong>
                                                    </div>
													</a>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3" style="margin-right: 35px; margin-left: 50px;">
													<a href="enviar_sol_func.php">
                                                    <span style='color:red; font-size:10px;'><i class="fa fa-play"></i></span><strong>&nbsp;&nbsp;Enviar Solicitações</strong>
                                                    </div>
													</a>
                                                </div>
