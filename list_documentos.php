        ...
        <div class="content-wrapper">
            ...
            <form id="formPersonalData" action="atualizar_form_dadosprofissionais.php" method="post">  
                ...
                <div class="col-md-2">
                        ...
                        <label for="exec_org">Portaria</label>
            ...
            <br><hr>
                ...
                <div class="row" style='margin-left: 1em;'>
                        <div class="col-md-8">
                            ...
                            <a href="imprimir_dadospessoais.php?cpf_func=<?php echo $cpf_func; ?>"><button class="btn btn-primary" type="button">Imprimir</button></a>&nbsp;&nbsp;&nbsp;&nbsp;
