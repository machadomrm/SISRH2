...
const locations = {
    ...
    RS: [
        ...
        "São Miguel Das Missġes",
        "São Nicolau",
        "São Paulo Das Missġes",
        "São Pedro da Serra",
        "São Pedro Das Missġes",
        "São Pedro do Butiá",
        "São Pedro do Sul",
...
const setListCity = (state) => {
    ...
    cityList.map((option) => createOptions(option, inputs.city));
};
// get new city list
...
const setListStates = () => {
    ...
    stateList.map((option) => createOptions(option, inputs.state));
    getNewCityList();
};
// get values from api
...
const setAddressData = async(promiseData, event) => {
    ...
    inputs.postalCode.value = parseInt(addressData.cep.replace(/[\s.-]*/gim, ""));
